...
<div class="page-header">
    <div class="page-title">
        ...
        <p>Register a new system hardware or infrastructure asset in the inventory.</p>
    </div>
...
<form action="{{ route('inventory.assets.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="asset_name" id="asset_name" class="form-control" placeholder="e.g. Core-Router-01" required value="{{ old('asset_name') }}">
                </div>
                <div class="form-group">
                    ...
                    <select name="asset_type" id="asset_type" class="form-control" required>
                        ...
                        <option value="Router" {{ old('asset_type') == 'Router' ? 'selected' : '' }}>Router</option>
                        <option value="Switch" {{ old('asset_type') == 'Switch' ? 'selected' : '' }}>Switch</option>
                        <option value="Server" {{ old('asset_type') == 'Server' ? 'selected' : '' }}>Server</option>
                        <option value="Firewall" {{ old('asset_type') == 'Firewall' ? 'selected' : '' }}>Firewall</option>
                        <option value="Access Point" {{ old('asset_type') == 'Access Point' ? 'selected' : '' }}>Access Point</option>
                        <option value="Controller" {{ old('asset_type') == 'Controller' ? 'selected' : '' }}>Controller</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="asset_category" id="asset_category" class="form-control" required>
                        ...
                        <option value="Network Infrastructure" {{ old('asset_category') == 'Network Infrastructure' ? 'selected' : '' }}>Network Infrastructure</option>
                        <option value="Security Infrastructure" {{ old('asset_category') == 'Security Infrastructure' ? 'selected' : '' }}>Security Infrastructure</option>
                        <option value="Server Infrastructure" {{ old('asset_category') == 'Server Infrastructure' ? 'selected' : '' }}>Server Infrastructure</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" readonly disabled placeholder="AST-{{ date('Y') }}-XXXX" style="background-color: var(--border-color); cursor: not-allowed;">
                </div>
                <div class="form-group">
                    <label for="asset_group" style="font-weight: 600;">Asset Group</label>
                    <select name="asset_group" id="asset_group" class="form-control">
                        <option value="Core Network" {{ old('asset_group') == 'Core Network' ? 'selected' : '' }}>Core Network</option>
                        <option value="Distribution Network" {{ old('asset_group') == 'Distribution Network' ? 'selected' : '' }}>Distribution Network</option>
                        <option value="Access Network" {{ old('asset_group') == 'Access Network' ? 'selected' : '' }}>Access Network</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="criticality" id="criticality" class="form-control" required>
                        <option value="Critical" {{ old('criticality') == 'Critical' ? 'selected' : '' }}>Critical</option>
                ...
                <div class="form-group">
                    ...
                    <select name="availability_requirement" id="availability_requirement" class="form-control">
                        <option value="24 x 7" {{ old('availability_requirement') == '24 x 7' ? 'selected' : '' }}>24 x 7</option>
                        <option value="9 x 5" {{ old('availability_requirement') == '9 x 5' ? 'selected' : '' }}>9 x 5</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="manufacturer" id="manufacturer" class="form-control" required>
                        ...
                        <option value="Cisco" {{ old('manufacturer') == 'Cisco' ? 'selected' : '' }}>Cisco</option>
                        <option value="HP" {{ old('manufacturer') == 'HP' ? 'selected' : '' }}>HP</option>
                        <option value="Dell" {{ old('manufacturer') == 'Dell' ? 'selected' : '' }}>Dell</option>
                        <option value="Palo Alto" {{ old('manufacturer') == 'Palo Alto' ? 'selected' : '' }}>Palo Alto</option>
                        <option value="Fortinet" {{ old('manufacturer') == 'Fortinet' ? 'selected' : '' }}>Fortinet</option>
                        <option value="Juniper" {{ old('manufacturer') == 'Juniper' ? 'selected' : '' }}>Juniper</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="model_number" style="font-weight: 600;">Model Number <span style="color: var(--status-down);">*</span></label>
                    <input type="text" name="model_number" id="model_number" class="form-control" placeholder="e.g. ISR 4331" required value="{{ old('model_number') }}">
                </div>
                <div class="form-group">
                    <label for="serial_number" style="font-weight: 600;">Serial Number <span style="color: var(--status-down);">*</span></label>
                    <input type="text" name="serial_number" id="serial_number" class="form-control" placeholder="e.g. FGL2148X2YZ" required value="{{ old('serial_number') }}">
                </div>
                <div class="form-group">
                    <label for="part_number" style="font-weight: 600;">Part Number</label>
                    <input type="text" name="part_number" id="part_number" class="form-control" placeholder="e.g. ISR4331/K9" value="{{ old('part_number') }}">
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    <label for="firmware_version" style="font-weight: 600;">Firmware Version</label>
                    <input type="text" name="firmware_version" id="firmware_version" class="form-control" placeholder="e.g. 17.06.04" value="{{ old('firmware_version') }}">
                </div>
                <div class="form-group">
                    <label for="hardware_version" style="font-weight: 600;">Hardware Version</label>
                    <input type="text" name="hardware_version" id="hardware_version" class="form-control" placeholder="e.g. V01" value="{{ old('hardware_version') }}">
                </div>
                <div class="form-group">
                    <label for="mac_address" style="font-weight: 600;">MAC Address</label>
                    <input type="text" name="mac_address" id="mac_address" class="form-control" placeholder="e.g. 00:11:22:33:44:55" value="{{ old('mac_address') }}">
                </div>
                <div class="form-group">
                    <label for="ean_imei" style="font-weight: 600;">EAN / IMEI (if any)</label>
                    <input type="text" name="ean_imei" id="ean_imei" class="form-control" placeholder="Enter EAN / IMEI" value="{{ old('ean_imei') }}">
                </div>
            </div>
        </div>
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="management_ip" id="management_ip" class="form-control" placeholder="e.g. 10.10.1.1" required value="{{ old('management_ip') }}">
                </div>
                <div class="form-group">
                    <label for="hostname" style="font-weight: 600;">Hostname</label>
                    <input type="text" name="hostname" id="hostname" class="form-control" placeholder="e.g. Core-Router-01" value="{{ old('hostname') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="snmp_community_user" id="snmp_community_user" class="form-control" placeholder="e.g. Anvica_NMS" value="{{ old('snmp_community_user') }}">
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    <label for="read_community" style="font-weight: 600;">Read Community</label>
                    <input type="text" name="read_community" id="read_community" class="form-control" placeholder="e.g. Anvica_NMS" value="{{ old('read_community') }}">
                </div>
                <div class="form-group">
                    <label for="write_community" style="font-weight: 600;">Write Community</label>
                    <div style="position: relative; display: flex; align-items: center;">
                        <input type="password" name="write_community" id="write_community" class="form-control" placeholder="••••••••••••" value="{{ old('write_community') }}" style="padding-right: 2.5rem; width: 100%;">
                ...
                <div class="form-group" style="display: flex; flex-direction: column; justify-content: center; gap: 0.25rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.25rem;">
                        <input type="checkbox" name="ssh_enabled" id="ssh_enabled" value="1" {{ old('ssh_enabled') ? 'checked' : '' }}>
                ...
                <div class="form-group" style="display: flex; flex-direction: column; justify-content: center; gap: 0.25rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.25rem;">
                        <input type="checkbox" name="telnet_enabled" id="telnet_enabled" value="1" {{ old('telnet_enabled') ? 'checked' : '' }}>
            ...
            <div style="background-color: var(--bg-up); border: 1px solid rgba(59, 130, 246, 0.1); border-radius: 8px; padding: 1rem; margin-top: 1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <input type="checkbox" name="auto_discover_snmp" id="auto_discover_snmp" value="1" {{ old('auto_discover_snmp', true) ? 'checked' : '' }}>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <input type="checkbox" name="auto_import_interfaces" id="auto_import_interfaces" value="1" {{ old('auto_import_interfaces', true) ? 'checked' : '' }}>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <input type="checkbox" name="auto_import_software" id="auto_import_software" value="1" {{ old('auto_import_software', true) ? 'checked' : '' }}>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <input type="checkbox" name="auto_import_config_backup" id="auto_import_config_backup" value="1" {{ old('auto_import_config_backup') ? 'checked' : '' }}>
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                    ...
                    @if(auth()->user()->isAdmin())
                        <select name="customer_id" id="customer_id" class="form-control" required>
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('customer_id', auth()->id()) == $user->id ? 'selected' : '' }}>
                                    {{ $user->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <select name="region" id="region" class="form-control">
                        <option value="West Zone" {{ old('region') == 'West Zone' ? 'selected' : '' }}>West Zone</option>
                        <option value="East Zone" {{ old('region') == 'East Zone' ? 'selected' : '' }}>East Zone</option>
                        <option value="North Zone" {{ old('region') == 'North Zone' ? 'selected' : '' }}>North Zone</option>
                        <option value="South Zone" {{ old('region') == 'South Zone' ? 'selected' : '' }}>South Zone</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="site_location" id="site_location" class="form-control" required>
                        <option value="Ahmedabad DC" {{ old('site_location') == 'Ahmedabad DC' ? 'selected' : '' }}>Ahmedabad DC</option>
                        <option value="Mumbai DC" {{ old('site_location') == 'Mumbai DC' ? 'selected' : '' }}>Mumbai DC</option>
                        <option value="Bangalore DC" {{ old('site_location') == 'Bangalore DC' ? 'selected' : '' }}>Bangalore DC</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="building_floor" style="font-weight: 600;">Building / Floor</label>
                    <input type="text" name="building_floor" id="building_floor" class="form-control" placeholder="e.g. Data Center - 1" value="{{ old('building_floor') }}">
                </div>
                <div class="form-group">
                    <label for="rack" style="font-weight: 600;">Rack</label>
                    <select name="rack" id="rack" class="form-control">
                        <option value="Rack-01" {{ old('rack') == 'Rack-01' ? 'selected' : '' }}>Rack-01</option>
                        <option value="Rack-02" {{ old('rack') == 'Rack-02' ? 'selected' : '' }}>Rack-02</option>
                        <option value="Rack-03" {{ old('rack') == 'Rack-03' ? 'selected' : '' }}>Rack-03</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="rack_unit" style="font-weight: 600;">Rack Unit (U)</label>
                    <select name="rack_unit" id="rack_unit" class="form-control">
                        <option value="U-12" {{ old('rack_unit') == 'U-12' ? 'selected' : '' }}>U-12</option>
                        <option value="U-13" {{ old('rack_unit') == 'U-13' ? 'selected' : '' }}>U-13</option>
                        <option value="U-14" {{ old('rack_unit') == 'U-14' ? 'selected' : '' }}>U-14</option>
                        <option value="U-15" {{ old('rack_unit') == 'U-15' ? 'selected' : '' }}>U-15</option>
                    </select>
                </div>
            </div>
            <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 1.25rem; margin-top: 1.25rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="gps_coordinates" id="gps_coordinates" class="form-control" placeholder="23.0225, 72.5714" value="{{ old('gps_coordinates') }}">
                </div>
                <div class="form-group">
                    <label for="zone" style="font-weight: 600;">Zone</label>
                    <select name="zone" id="zone" class="form-control">
                        <option value="DC Network" {{ old('zone') == 'DC Network' ? 'selected' : '' }}>DC Network</option>
                        <option value="DMZ" {{ old('zone') == 'DMZ' ? 'selected' : '' }}>DMZ</option>
                        <option value="LAN" {{ old('zone') == 'LAN' ? 'selected' : '' }}>LAN</option>
                        <option value="WAN" {{ old('zone') == 'WAN' ? 'selected' : '' }}>WAN</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="vendor" id="vendor" class="form-control" required>
                        ...
                        @foreach($vendors as $vendor)
                            <option value="{{ $vendor->name }}" {{ old('vendor') == $vendor->name ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_reseller" id="supplier_reseller" class="form-control" placeholder="e.g. ABC Technologies Pvt. Ltd." value="{{ old('supplier_reseller') }}">
                </div>
                <div class="form-group">
                    <label for="purchase_order_no" style="font-weight: 600;">Purchase Order No.</label>
                    <input type="text" name="purchase_order_no" id="purchase_order_no" class="form-control" placeholder="PO-2026-1001" value="{{ old('purchase_order_no') }}">
                </div>
                <div class="form-group">
                    <label for="invoice_no" style="font-weight: 600;">Invoice No.</label>
                    <input type="text" name="invoice_no" id="invoice_no" class="form-control" placeholder="INV-2026-101" value="{{ old('invoice_no') }}">
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="commissioning_date" id="commissioning_date" class="form-control" value="{{ old('commissioning_date') }}">
                </div>
                <div class="form-group">
                    <label for="cost" style="font-weight: 600;">Cost (INR)</label>
                    <input type="number" name="cost" id="cost" class="form-control" min="0" step="0.01" placeholder="3,45,000.00" value="{{ old('cost') }}">
                </div>
            </div>
        </div>
                ...
                <div style="border-right: 1px solid var(--border-color); padding-right: 2rem;">
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        ...
                        <select name="warranty_status" id="warranty_status" class="form-control">
                            <option value="Active" {{ old('warranty_status') == 'Active' ? 'selected' : '' }}>Active</option>
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        ...
                        <input type="date" name="warranty_start_date" id="warranty_start_date" class="form-control" value="{{ old('warranty_start_date') }}">
                    </div>
                    <div class="form-group">
                ...
                <div>
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        ...
                        <select name="amc_status" id="amc_status" class="form-control">
                            <option value="Active" {{ old('amc_status') == 'Active' ? 'selected' : '' }}>Active</option>
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        ...
                        <input type="date" name="amc_start_date" id="amc_start_date" class="form-control" value="{{ old('amc_start_date') }}">
                    </div>
                    <div class="form-group">
                        <label for="amc_end_date" style="font-weight: 600;">End Date</label>
                        <input type="date" name="amc_end_date" id="amc_end_date" class="form-control" value="{{ old('amc_end_date') }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="sla_policy" id="sla_policy" class="form-control" required>
                        <option value="Gold SLA" {{ old('sla_policy') == 'Gold SLA' ? 'selected' : '' }}>Gold SLA</option>
                        <option value="Silver SLA" {{ old('sla_policy') == 'Silver SLA' ? 'selected' : '' }}>Silver SLA</option>
                        <option value="Bronze SLA" {{ old('sla_policy') == 'Bronze SLA' ? 'selected' : '' }}>Bronze SLA</option>
                        <option value="Standard SLA" {{ old('sla_policy', 'Standard SLA') == 'Standard SLA' ? 'selected' : '' }}>Standard SLA</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="service_name" id="service_name" class="form-control" required>
                        <option value="Corporate WAN" {{ old('service_name') == 'Corporate WAN' ? 'selected' : '' }}>Corporate WAN</option>
                        <option value="Internet Leased Line" {{ old('service_name') == 'Internet Leased Line' ? 'selected' : '' }}>Internet Leased Line</option>
                        <option value="MPLS Link" {{ old('service_name') == 'MPLS Link' ? 'selected' : '' }}>MPLS Link</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="business_unit" id="business_unit" class="form-control">
                        ...
                        <option value="Security Operations" {{ old('business_unit') == 'Security Operations' ? 'selected' : '' }}>Security Operations</option>
                        <option value="Finance" {{ old('business_unit') == 'Finance' ? 'selected' : '' }}>Finance</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="sla_availability" id="sla_availability" class="form-control">
                        <option value="99.99%" {{ old('sla_availability') == '99.99%' ? 'selected' : '' }}>99.99%</option>
                        <option value="99.95%" {{ old('sla_availability') == '99.95%' ? 'selected' : '' }}>99.95%</option>
                        <option value="99.9%" {{ old('sla_availability') == '99.9%' ? 'selected' : '' }}>99.9%</option>
                    </select>
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="response_sla" id="response_sla" class="form-control">
                        <option value="15 Minutes" {{ old('response_sla') == '15 Minutes' ? 'selected' : '' }}>15 Minutes</option>
                        <option value="30 Minutes" {{ old('response_sla') == '30 Minutes' ? 'selected' : '' }}>30 Minutes</option>
                        <option value="1 Hour" {{ old('response_sla') == '1 Hour' ? 'selected' : '' }}>1 Hour</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="resolution_sla" id="resolution_sla" class="form-control">
                        <option value="2 Hours" {{ old('resolution_sla') == '2 Hours' ? 'selected' : '' }}>2 Hours</option>
                        <option value="4 Hours" {{ old('resolution_sla') == '4 Hours' ? 'selected' : '' }}>4 Hours</option>
                        <option value="8 Hours" {{ old('resolution_sla') == '8 Hours' ? 'selected' : '' }}>8 Hours</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="escalation_sla" id="escalation_sla" class="form-control">
                        <option value="30 Minutes" {{ old('escalation_sla') == '30 Minutes' ? 'selected' : '' }}>30 Minutes</option>
                        <option value="1 Hour" {{ old('escalation_sla') == '1 Hour' ? 'selected' : '' }}>1 Hour</option>
                        <option value="2 Hours" {{ old('escalation_sla') == '2 Hours' ? 'selected' : '' }}>2 Hours</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="business_impact" id="business_impact" class="form-control">
                        <option value="High" {{ old('business_impact') == 'High' ? 'selected' : '' }}>High</option>
                        <option value="Medium" {{ old('business_impact') == 'Medium' ? 'selected' : '' }}>Medium</option>
                        <option value="Low" {{ old('business_impact') == 'Low' ? 'selected' : '' }}>Low</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="number" name="cpu_utilization_threshold" id="cpu_utilization_threshold" class="form-control" min="0" max="100" value="{{ old('cpu_utilization_threshold', 85) }}">
                </div>
                <div class="form-group">
                    <label for="memory_utilization_threshold" style="font-weight: 600;">Memory Utilization Threshold (%)</label>
                    <input type="number" name="memory_utilization_threshold" id="memory_utilization_threshold" class="form-control" min="0" max="100" value="{{ old('memory_utilization_threshold', 80) }}">
                </div>
                <div class="form-group">
                    <label for="packet_loss_threshold" style="font-weight: 600;">Packet Loss Threshold (%)</label>
                    <input type="number" name="packet_loss_threshold" id="packet_loss_threshold" class="form-control" min="0" max="100" value="{{ old('packet_loss_threshold', 2) }}">
                </div>
                <div class="form-group">
                    <label for="temperature_threshold" style="font-weight: 600;">Temperature Threshold (°C)</label>
                    <input type="number" name="temperature_threshold" id="temperature_threshold" class="form-control" min="0" max="150" value="{{ old('temperature_threshold', 70) }}">
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group" style="display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.25rem;">
                        <input type="checkbox" name="health_monitoring" id="health_monitoring" value="1" {{ old('health_monitoring', true) ? 'checked' : '' }}>
                ...
                <div class="form-group" style="display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.25rem;">
                        <input type="checkbox" name="health_score_calculation" id="health_score_calculation" value="1" {{ old('health_score_calculation', true) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select name="polling_interval" id="polling_interval" class="form-control">
                        <option value="1 Minute" {{ old('polling_interval') == '1 Minute' ? 'selected' : '' }}>1 Minute</option>
                        <option value="5 Minutes" {{ old('polling_interval') == '5 Minutes' ? 'selected' : '' }}>5 Minutes</option>
                        <option value="15 Minutes" {{ old('polling_interval') == '15 Minutes' ? 'selected' : '' }}>15 Minutes</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="alert_profile" id="alert_profile" class="form-control">
                        <option value="Default" {{ old('alert_profile') == 'Default' ? 'selected' : '' }}>Default</option>
                        <option value="Critical Only" {{ old('alert_profile') == 'Critical Only' ? 'selected' : '' }}>Critical Only</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <select name="asset_owner" id="asset_owner" class="form-control" required>
                        <option value="IT Head" {{ old('asset_owner') == 'IT Head' ? 'selected' : '' }}>IT Head</option>
                        <option value="VP Infrastructure" {{ old('asset_owner') == 'VP Infrastructure' ? 'selected' : '' }}>VP Infrastructure</option>
                        <option value="CIO" {{ old('asset_owner') == 'CIO' ? 'selected' : '' }}>CIO</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="custodian_department" id="custodian_department" class="form-control" required>
                        <option value="Network Operations" {{ old('custodian_department') == 'Network Operations' ? 'selected' : '' }}>Network Operations</option>
                        <option value="IT Support" {{ old('custodian_department') == 'IT Support' ? 'selected' : '' }}>IT Support</option>
                        <option value="Security Operations" {{ old('custodian_department') == 'Security Operations' ? 'selected' : '' }}>Security Operations</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="responsible_person" id="responsible_person" class="form-control" required>
                        <option value="Vijay Kumar" {{ old('responsible_person') == 'Vijay Kumar' ? 'selected' : '' }}>Vijay Kumar</option>
                        <option value="Rohan Shah" {{ old('responsible_person') == 'Rohan Shah' ? 'selected' : '' }}>Rohan Shah</option>
                        <option value="Sanjay Mehta" {{ old('responsible_person') == 'Sanjay Mehta' ? 'selected' : '' }}>Sanjay Mehta</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="contact_number" style="font-weight: 600;">Contact Number</label>
                    <input type="text" name="contact_number" id="contact_number" class="form-control" placeholder="+91 98765 43210" value="{{ old('contact_number') }}">
                </div>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-top: 1.25rem;">
                <div class="form-group">
                    <label for="email_id" style="font-weight: 600;">Email ID</label>
                    <input type="email" name="email_id" id="email_id" class="form-control" placeholder="e.g. vijay.kumar@westernrail.in" value="{{ old('email_id') }}">
                </div>
                <div class="form-group">
                    <label for="escalation_group" style="font-weight: 600;">Escalation Group</label>
                    <select name="escalation_group" id="escalation_group" class="form-control">
                        ...
                        <option value="Desktop Support Team" {{ old('escalation_group') == 'Desktop Support Team' ? 'selected' : '' }}>Desktop Support Team</option>
                        <option value="Server Team" {{ old('escalation_group') == 'Server Team' ? 'selected' : '' }}>Server Team</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="notification_group" id="notification_group" class="form-control">
                        <option value="NOC Team" {{ old('notification_group') == 'NOC Team' ? 'selected' : '' }}>NOC Team</option>
                        <option value="SOC Team" {{ old('notification_group') == 'SOC Team' ? 'selected' : '' }}>SOC Team</option>
                        <option value="Support Helpdesk" {{ old('notification_group') == 'Support Helpdesk' ? 'selected' : '' }}>Support Helpdesk</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div style="background: white; border-radius: 12px; padding: 1.75rem; box-shadow: var(--card-shadow);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" class="form-control" rows="4" placeholder="Enter any additional notes about this asset...">{{ old('notes') }}</textarea>
                </div>
            </div>
        </div>
