    ...
    public function run(): void
    {
        $services = [
            'Router' => [
                'icon' => 'router',
                'points' => [
                    ['CPU Usage', 'cpu', 'SNMP', '%', 80, 95],
                    ['RAM Usage', 'ram', 'SNMP', '%', 90, 95],
                    ['Internet Traffic', 'traffic', 'SNMP', 'bps', null, null],
                    ['VPN Status', 'vpn-status', 'API', null, null, null],
                    ['Uptime', 'uptime', 'SNMP', null, null, null],
                    ['Packet Drops', 'packet-drops', 'SNMP', 'count', null, null],
                    ['Temperature', 'temperature', 'SNMP', 'C', 70, 85],
                    ['WAN Status', 'wan-status', 'Ping/SNMP', null, null, null],
                ],
